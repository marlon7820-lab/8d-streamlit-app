...
npqp_steps = [
    ...
    ("D5", {"en":"Use 5-Why analysis to determine the root cause.", "es":"Use el análisis de 5 Porqués para determinar la causa raíz."}, {"en":"Use 5-Why analysis to determine the root cause.","es":"es": "Use el análisis de 5 Porqués para determinar la causa raíz."}),
