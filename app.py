...
npqp_steps = [
    ...
    ("D5", {"en":"Use 5-Why analysis to determine the root cause.", "es":"Use el análisis de 5 Porqués para determinar la causa raíz."}, {"en":"Final "Why" from the Analysis will give a good indication of the True Root Cause","es":"El ultimo "Por que" del analisis proporsionara una idea clara de la causa raiz del problema"}),
