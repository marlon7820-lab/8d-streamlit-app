...
def full_reset():
    ...
    # Use JS redirect to mimic full page reload
...
# D5 categories
# ---------------------------
occurrence_categories = { ... }  # keep same as baseline
detection_categories = { ... }  # keep same as baseline
systemic_categories = { ... }  # keep same as baseline
